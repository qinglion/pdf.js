...
SVG.extend(SVG.Element, {
  ...
  draw: function (event, options, value) {
    ...
    let paintHandler = this.remember('_paintHandler') || new PaintHandler(this, event, options || {})
...
SVG.Element.prototype.draw.extend('line polyline polygon', {
  ...
  drawCircles () {
    ...
    for (let i = 0; i < array.length; ++i) {
      ...
      let p = this.p.matrixTransform(this.parent.node.getScreenCTM().inverse().multiply(this.el.node.getScreenCTM()))
